...
output_site = "T3_US_FNALLPC" #CMU: T3_US_CMU
    ...
    with open(args.yaml) as f:
        ...
        for sample in sorted(doc["samples"].keys()):
            ...
            for dataset_shortname, dataset in info['datasets'].items():            
                ...
                this_config.JobType.maxMemoryMB = 5500 #It was initially 8000, but I reduced it in order to prevent jobs to sit in "Pending" queue for a long time
